     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3  style="background-color: #045; padding:15px; color: rgb(200,25,165);"></i> Register Complaint</h3>
...
<select name="complaintype" class="form-control" required="">
                ...
                <option value=" Complaint"> Complicated</option>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Responsible Person</label>
<div class="col-sm-4">
<input type="text" name="noc" required="required" value="" required="" class="form-control" placeholder="Enter the resource person name.">
</div>
...
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000" placeholder="Provide detailed information......"></textarea>
</div>
</div>
<div class="form-group">
